...
export const CreateMember = () => {
    ...
    return (
        <main className="w-full flex flex-colpy-4 flex-grow max-w-5xl justify-center">
            <div className="max-w-2xl border-2 vorder-blue-600 rounded-xl p-3 mt-10 h-full">
                <div className="flex flex-col justify-center">
                    <span>You are not a member</span>
                    <p>
                        Add <strong>2 MATIC</strong> to become member and more that 2 MATIC 
                    ...
                    />
                    <button
                        className="px-3 py-2 rounded-xl bg-blue"
                        onClick={() => {
